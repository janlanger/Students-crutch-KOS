...
class ImportPresenter extends CliPresenter {
    ...
    public function actionDefault() {
        ...
        echo ' - download - Only downloads new rz.xml if available.' . PHP_EOL;
        echo ' - import - Import rz.xml to the database and run the update afterwards. (optional param --file "filepath") for importing specifik file. If no file is provided, new is dowloaded.' . PHP_EOL;
