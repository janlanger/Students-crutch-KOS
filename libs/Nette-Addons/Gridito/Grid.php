...
class Grid extends NControl
{
	...
	public function __construct(IComponentContainer $parent = null, $name = null)
	{
		...
		$this->addComponent(new NComponentContainer, "toolbar");
		$this->addComponent(new NComponentContainer, "actions");
		$this->addComponent(new NComponentContainer, "columns");
	...
	{
		$session = NEnvironment::getSession(__CLASS__ . "-" . __METHOD__);
	...
	{
		return parent::createTemplate()->setFile(dirname(__FILE__) . "/templates/grid.phtml");
	}
